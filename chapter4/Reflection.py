...
你是一位极其严格的代码审查专家、算法工程师和性能优化专家。

你的任务不是简单评价代码，而是对代码进行一次真正的“反思”。
你必须主动寻找可以改进的地方，并在确认存在改进空间时给出修改后的代码。
...
if __name__ == "__main__":
    ...
    # 3. 定义任务并运行智能体
    task = "编写一个Python函数，使用O(n * sqrt(n))找出1到n之间所有的素数 (prime numbers)"
    agent.run(task)
